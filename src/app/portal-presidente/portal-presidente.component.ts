...
@Component({
  selector: 'app-portal-presidente',
  templateUrl: './portal-presidente.component.html',
  styleUrls: ['./portal-presidente.component.css']
})

export class PortalPresidenteComponent implements OnInit {
  roleOptions = '';
  selectedValue : any;
  closeResult: string;
  User = [];
  ...
  toggleShowSolicitudes=false;
  toggleViewSolicitudes=false;
