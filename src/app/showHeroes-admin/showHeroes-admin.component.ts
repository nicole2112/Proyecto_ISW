...
export class ShowHeroesAdminComponent implements OnInit {
  ...
  onChangeVisibilidad(event : any){
    ...
    // let errorLabel = document.getElementById('error-label-visibilidad') as HTMLLabelElement;
    // let submitButton = document.getElementById('saveBtn') as HTMLButtonElement;

    // if(this.selectedValue === 'Visibilidad'){
    //   errorLabel.innerText = '*Seleccione una opcion valida*';
    //   this.checkVisibilidad = false;
    //   submitButton.disabled = true;
    // }else{
    //   errorLabel.innerText = '';
    //   this.checkVisibilidad = true;
    // }

    // if(this.checkVisibilidad == true && this.checkPrioridad == true && this.checkFallecido == true){
  ...
  onChangePrioridad(event : any){
    // var selector = document.getElementById('prioridadOptions') as HTMLSelectElement;
    // this.selectedValue = selector.options[selector.selectedIndex].text;

    // let errorLabel = document.getElementById('error-label-prioridad') as HTMLLabelElement;
    // let submitButton = document.getElementById('saveBtn') as HTMLButtonElement;

    // if(this.selectedValue === 'Prioridad'){
    //   errorLabel.innerText = '*Seleccione una opcion valida*';
    //   this.checkPrioridad = false;
    //   submitButton.disabled = true;
    // }else{
    //   errorLabel.innerText = '';
    //   this.checkPrioridad = true;
    // }
  ...
  onChangeFallecido(event : any){
    // var selector = document.getElementById('fallecidoOptions') as HTMLSelectElement;
    // this.selectedValue = selector.options[selector.selectedIndex].text;

    // let errorLabel = document.getElementById('error-label-fallecido') as HTMLLabelElement;
    // let submitButton = document.getElementById('saveBtn') as HTMLButtonElement;

    // if(this.selectedValue === 'Fallecido'){
    //   errorLabel.innerText = '*Seleccione una opcion valida*';
    //   this.checkFallecido = false;
    //   submitButton.disabled = true;
    // }else{
    //   errorLabel.innerText = '';
    //   this.checkFallecido = true;
    // }
